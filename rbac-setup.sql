...
INSERT INTO public.role_permissions (role, table_name, can_view, can_read, can_write, can_delete) VALUES
  ...
  ('admin', 'page:announcements',        true, true, true, true),
  ('admin', 'page:motivational-messages', true, true, true, true),
  ('admin', 'page:quotes',               true, true, true, true),
  -- DB-table entries (for RLS)
  ('admin', 'announcements',         true, true, true, true),
  ('admin', 'motivational_messages', true, true, true, true),
...
INSERT INTO public.role_permissions (role, table_name, can_view, can_read, can_write, can_delete) VALUES
  ...
  ('teacher', 'page:announcements',        true,  true,  true,  false),
  ('teacher', 'page:motivational-messages', true,  true,  true,  false),
  ('teacher', 'page:quotes',               true,  true,  true,  false),
  -- DB-table entries (for RLS)
  ('teacher', 'announcements',         true, true,  true,  false),
  ('teacher', 'motivational_messages', true, true,  true,  false),
  ('teacher', 'quotes',               true, true,  true,  false),
...
INSERT INTO public.role_permissions (role, table_name, can_view, can_read, can_write, can_delete) VALUES
  ...
  ('student', 'page:announcements',        false, false, false, false),
  ('student', 'page:motivational-messages', false, false, false, false),
  ('student', 'page:quotes',               false, false, false, false),
  -- DB-table entries (for RLS)
  ('student', 'announcements',         true, true,  false, false),
  ('student', 'motivational_messages', true, true,  false, false),
  ('student', 'quotes',               true, true,  false, false),
...
INSERT INTO public.role_permissions (role, table_name, can_view, can_read, can_write, can_delete) VALUES
  ...
  ('accountant', 'page:announcements',        false, false, false, false),
  ('accountant', 'page:motivational-messages', false, false, false, false),
  ('accountant', 'page:quotes',               false, false, false, false),
  -- DB-table entries (for RLS)
  ('accountant', 'announcements',         true, false, false, false),
  ('accountant', 'motivational_messages', true, false, false, false),
  ('accountant', 'quotes',               true, false, false, false),
